...
namespace SeiyuuDB.Core.Helpers {
  public static class EnumHelper {
    public static readonly Dictionary<CompanyType, string> CompanyTypeDisplayNames =
      new Dictionary<CompanyType, string>() {
        { CompanyType.Empty, "" },
        { CompanyType.Agency, "事務所" },
        { CompanyType.Station, "放送局" }
      };

    public static readonly Dictionary<Gender, string> GenderDisplayNames =
    ...
    public static readonly Dictionary<BloodType, string> BloodTypeDisplayNames =
      new Dictionary<BloodType, string>() {
        { BloodType.Empty, "" },
        { BloodType.A, "A型" },
        { BloodType.B, "B型" },
        { BloodType.O, "O型" },
